...
void SceneManager::DefineObjectMaterials()
{
	...
	pinkMaterial.ambientColor = glm::vec3(0.98f, 0.82f, 0.87f); // Soft pink
	pinkMaterial.ambientStrength = 0.2f; // Low ambient reflection
	pinkMaterial.diffuseColor = glm::vec3(0.98f, 0.82f, 0.87f); // Soft pink
	pinkMaterial.specularColor = glm::vec3(1.0f, 0.8f, 0.85f); // Slightly brighter pink for highlights
	pinkMaterial.shininess = 32.0f; // Higher shininess for a smoother surface
	pinkMaterial.tag = "clay";
...
void SceneManager::SetupSceneLights()
{
	...
	ShaderManager* m_pShaderManager = new ShaderManager();

	// Set light source 0 to a soft pink color
	m_pShaderManager->setVec3Value("lightSources[0].position", -3.0f, 4.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", 0.2f, 0.14f, 0.15f);
	m_pShaderManager->setVec3Value("lightSources[0].diffuseColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setVec3Value("lightSources[0].specularColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setFloatValue("lightSources[0].focalStrength", 32.0f);
	m_pShaderManager->setFloatValue("lightSources[0].specularIntensity", 0.2f);

	// Set light source 1 to a soft pink color (optional)
	m_pShaderManager->setVec3Value("lightSources[1].position", 3.0f, 4.0f, 6.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.2f, 0.14f, 0.15f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setVec3Value("lightSources[1].specularColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setFloatValue("lightSources[1].focalStrength", 32.0f);
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 0.2f);

	// Set light source 2 to a soft pink color
	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, 3.0f, 20.0f);
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", 0.2f, 0.14f, 0.15f);
	m_pShaderManager->setVec3Value("lightSources[2].diffuseColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setVec3Value("lightSources[2].specularColor", 0.98f, 0.82f, 0.87f);
	...
	// Set light source 3 to a soft pink color
	m_pShaderManager->setVec3Value("lightSources[3].position", 0.0f, 3.0f, 20.0f);
	m_pShaderManager->setVec3Value("lightSources[3].ambientColor", 0.2f, 0.14f, 0.15f);
	m_pShaderManager->setVec3Value("lightSources[3].diffuseColor", 0.98f, 0.82f, 0.87f);
	m_pShaderManager->setVec3Value("lightSources[3].specularColor", 0.98f, 0.82f, 0.87f);
